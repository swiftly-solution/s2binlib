...
#ifndef _s2binlib_s2binlib003_h
#define _s2binlib_s2binlib003_h
...
#define S2BINLIB_INTERFACE_NAME "S2BINLIB003"
    ...
    /// Create a new S2BinLib003 instance
    /// @param interface_name Interface name to create
    /// @return Pointer to the created instance, or nullptr on failure
    typedef S2BinLib003 *(*S2CreateInterfaceFn)(const char *interface_name);

#ifdef __cplusplus
}

/// S2BinLib003 class - Interface version 003
...
public:
    ...
    /// Destroy the S2BinLib003 instance
    virtual int Destroy() = 0;
};

#endif // __cplusplus

#endif // _s2binlib_s2binlib003_h
