...
macro_rules! c_debug {
    ($($arg:tt)*) => {
        println!("[S2BinLib003 Debug] {}", format!($($arg)*));
    };
}
...
macro_rules! get_s2binlib_mut {
    ($this:expr) => {{
        ...
        if s2binlib.is_none() {
            return_error!(-1, "S2BinLib003 is not initialized");
        }
        s2binlib.unwrap()
    }};
}
...
#[repr(C)]
pub struct S2BinLib003 {
    pub vtable: *const S2BinLib003VTable,
...
#[repr(C)]
pub struct S2BinLib003VTable {
    pub initialize: unsafe extern "C" fn(
        this: *mut S2BinLib003,
    ...
    pub clear_module_base_address:
        unsafe extern "C" fn(this: *mut S2BinLib003, binary_name: *const c_char) -> i32,
    ...
    pub get_module_base_address: unsafe extern "C" fn(
        this: *const S2BinLib003,
        binary_name: *const c_char,
        result: *mut *mut c_void,
    ) -> i32,
    pub is_binary_loaded:
        unsafe extern "C" fn(this: *const S2BinLib003, binary_name: *const c_char) -> i32,
    pub load_binary:
        unsafe extern "C" fn(this: *mut S2BinLib003, binary_name: *const c_char) -> i32,
    ...
    pub object_ptr_has_vtable:
        unsafe extern "C" fn(this: *const S2BinLib003, object_ptr: *const c_void) -> i32,
    ...
    pub dump_xrefs: unsafe extern "C" fn(this: *mut S2BinLib003, binary_name: *const c_char) -> i32,
    ...
    pub unload_binary:
        unsafe extern "C" fn(this: *mut S2BinLib003, binary_name: *const c_char) -> i32,
    pub unload_all_binaries: unsafe extern "C" fn(this: *mut S2BinLib003) -> i32,
    ...
    pub find_networkvar_vtable_statechanged_rva:
        unsafe extern "C" fn(this: *const S2BinLib003, vtable_rva: u64, result: *mut u64) -> i32,
    ...
    pub destroy: unsafe extern "C" fn(this: *mut S2BinLib003) -> i32,
}

static VTABLE: S2BinLib003VTable = S2BinLib003VTable {
...
unsafe extern "C" fn IsBinaryLoaded(this: *const S2BinLib003, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn LoadBinary(this: *mut S2BinLib003, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn DumpXrefs(this: *mut S2BinLib003, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn UnloadBinary(this: *mut S2BinLib003, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn UnloadAllBinaries(this: *mut S2BinLib003) -> i32 {
    check_null!(this);
...
unsafe extern "C" fn DumpVtables(this: *mut S2BinLib003, binary_name: *const c_char) -> i32 {
    check_null!(this, binary_name);
...
unsafe extern "C" fn Destroy(this: *mut S2BinLib003) -> i32 {
    check_null!(this);

    s2binlib003_destroy(this as *mut c_void);
    0
}

#[unsafe(no_mangle)]
pub extern "C" fn s2binlib003_create() -> *mut c_void {
    let s2binlib003 = Box::new(S2BinLib003::new());
    Box::into_raw(s2binlib003) as *mut c_void
}

fn s2binlib003_destroy(ptr: *mut c_void) {
    if !ptr.is_null() {
        unsafe {
            let _ = Box::from_raw(ptr as *mut S2BinLib003);
        }
    }
}
